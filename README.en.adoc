...
[NOTE]
====
This GDExtension is available for use with Godot Engine 4.1 and lator. (If you wish to use it with versions 4.3 and lator, please use link:https://github.com/MizunagiKB/gd_cubism/tree/0.8[0.8])
====
