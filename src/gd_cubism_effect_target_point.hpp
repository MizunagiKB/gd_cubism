...
public:
    ...
    virtual void _cubism_process(InternalCubismUserModel* model, const float delta) override {
        ...
        if(this->initialized == false) {
            Csm::csmInt32 v;
            // ANGLE_X
            v = this->find_idx(_model, Csm::csmString(this->head_angle_x.utf8().get_data()));
            ...
            // ANGLE_Y
            v = this->find_idx(_model, Csm::csmString(this->head_angle_y.utf8().get_data()));
            ...
            // ANGLE_Z
            v = this->find_idx(_model, Csm::csmString(this->head_angle_z.utf8().get_data()));
            ...
            // BODY_ANGLE_X
            v = this->find_idx(_model, Csm::csmString(this->body_angle_x.utf8().get_data()));
            ...
            // EYE_BALL_X
            v = this->find_idx(_model, Csm::csmString(this->eyes_ball_x.utf8().get_data()));
            ...
            // EYE_BALL_Y
            v = this->find_idx(_model, Csm::csmString(this->eyes_ball_y.utf8().get_data()));
