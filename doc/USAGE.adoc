...
|link:API/ja/API_gd_cubism_effect.ja.adoc[GDCubismEffect]
|GDCubismEffectCS
|-
...
|link:API/ja/API_gd_cubism_effect_custom.ja.adoc[GDCubismEffectCustom]
...
|link:API/ja/API_gd_cubism_effect_hit_area.ja.adoc[GDCubismEffectHitArea]
|GDCubismEffectHitAreaCS
|△

|link:API/ja/API_gd_cubism_effect_target_point.ja.adoc[GDCubismEffectTargetPoint]
...
|link:API/ja/API_gd_cubism_value_abs.ja.adoc[GDCubismValueAbs]
|GDCubismValueAbsCS
|-
