...
>|bool <|<<id-property-load_motins,load_motins>> |[default: true]
...
When this is specified, operations by link:./gd_cubism_parameter[_GDCubismParameter_] cannot be performed.
* NONE_PARAMETER = 1 +
Specify this when using the link:./gd_cubism_parameter[_GDCubismParameter_] obtained by the <<id-method-start_motion,_get_parameter_>> function to operate the Live2D model. +
...
[source,,numlines]
----
include::../../../demo/addons/gd_cubism/res/shader/2d_cubism_norm_add.gdshader[]
----
...
[source,,numlines]
----
include::../../../demo/addons/gd_cubism/res/shader/2d_cubism_mask_add.gdshader[]
----
...
[source,,numlines]
----
include::../../../demo/addons/gd_cubism/res/shader/2d_cubism_mask_add_inv.gdshader[]
----
...
[source,,numlines]
----
include::../../../demo/addons/gd_cubism/res/shader/2d_cubism_mask_mul.gdshader[]
----
...
[source,,numlines]
----
include::../../../demo/addons/gd_cubism/res/shader/2d_cubism_mask_mul_inv.gdshader[]
----
...
[source,,numlines]
----
include::../../../demo/addons/gd_cubism/res/shader/2d_cubism_norm_mul.gdshader[]
----
...
link:./gd_cubism_motion_queue_entry_handle[GDCubismMotionQueueEntryHandle] start_motion(group: String, no: int, priority: <<id-enum-priority,Priority>>)::
Plays the _Motion_ specified by _group_ and _no_.


[[id-method-start_motion_loop]]
link:./gd_cubism_motion_queue_entry_handle[GDCubismMotionQueueEntryHandle] start_motion_loop(group: String, no: int, priority: <<id-enum-priority,Priority>>)::
Plays the _Motion_ specified by _group_ and _no_. +
+
