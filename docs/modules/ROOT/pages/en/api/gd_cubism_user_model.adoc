...
When this is specified, operations by link:API_gd_cubism_parameter.ja.adoc[_GDCubismParameter_] cannot be performed.
* NONE_PARAMETER = 1 +
Specify this when using the link:API_gd_cubism_parameter.ja.adoc[_GDCubismParameter_] obtained by the <<id-method-start_motion,_get_parameter_>> function to operate the Live2D model. +
