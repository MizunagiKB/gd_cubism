...
|link:./api/API_gd_cubism_effect.ja{adocsuffix}[GDCubismEffect]
|GDCubismEffectCS
|-

|link:./api/API_gd_cubism_effect_breath.ja{adocsuffix}[GDCubismEffectBreath]
|GDCubismEffectBreathCS
|△

|link:./api/API_gd_cubism_effect_custom.ja{adocsuffix}[GDCubismEffectCustom]
|GDCubismEffectCustomCS
|△

|link:./api/API_gd_cubism_effect_eye_blink.ja{adocsuffix}[GDCubismEffectEyeBlink]
|GDCubismEffectEyeBlinkCS
|△

|link:./api/API_gd_cubism_effect_hit_area.ja{adocsuffix}[GDCubismEffectHitArea]
|GDCubismEffectHitAreaCS
|△

|link:./api/API_gd_cubism_effect_target_point.ja{adocsuffix}[GDCubismEffectTargetPoint]
|GDCubismEffectTargetPointCS
|△

|link:./api/API_gd_cubism_motion_entry.ja{adocsuffix}[GDCubismMotionEntry]
|GDCubismMotionEntryCS
|x

|link:./api/API_gd_cubism_motion_queue_entry_handle.ja{adocsuffix}[GDCubismMotionQueueEntryHandle]
|GDCubismMotionQueueEntryHadleCS
|x

|link:./api/API_gd_cubism_value_abs.ja{adocsuffix}[GDCubismValueAbs]
|GDCubismValueAbsCS
|-

|link:./api/API_gd_cubism_parameter.ja{adocsuffix}[GDCubismParameter]
|GDCubismParameterCS
|○
