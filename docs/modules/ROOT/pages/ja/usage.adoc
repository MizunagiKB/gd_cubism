...
link:../ja/usage{adocsuffix}[Japanese] / link:../en/usage{adocsuffix}[English]
...
image::res/images/usage_mipmap_01.png[mipmap01,256]

Mipmapの効果はかなり高いですが、絵によってはぼやけた感じとなる場合があります。

Mipmap適用なし

image::res/images/usage_mipmap_02a.jpg[mipmap02a,256]

Mipmap適用あり

image::res/images/usage_mipmap_02b.jpg[mipmap02b,256]
...
|link:API/ja/API_gd_cubism_effect.ja{adocsuffix}[GDCubismEffect]
|GDCubismEffectCS
|-

|link:API/ja/API_gd_cubism_effect_breath.ja{adocsuffix}[GDCubismEffectBreath]
|GDCubismEffectBreathCS
|△

|link:API/ja/API_gd_cubism_effect_custom.ja{adocsuffix}[GDCubismEffectCustom]
|GDCubismEffectCustomCS
|△

|link:API/ja/API_gd_cubism_effect_eye_blink.ja{adocsuffix}[GDCubismEffectEyeBlink]
|GDCubismEffectEyeBlinkCS
|△

|link:API/ja/API_gd_cubism_effect_hit_area.ja{adocsuffix}[GDCubismEffectHitArea]
|GDCubismEffectHitAreaCS
|△

|link:API/ja/API_gd_cubism_effect_target_point.ja{adocsuffix}[GDCubismEffectTargetPoint]
|GDCubismEffectTargetPointCS
|△

|link:API/ja/API_gd_cubism_motion_entry.ja{adocsuffix}[GDCubismMotionEntry]
|GDCubismMotionEntryCS
|x

|link:API/ja/API_gd_cubism_motion_queue_entry_handle.ja{adocsuffix}[GDCubismMotionQueueEntryHandle]
|GDCubismMotionQueueEntryHadleCS
|x

|link:API/ja/API_gd_cubism_value_abs.ja{adocsuffix}[GDCubismValueAbs]
|GDCubismValueAbsCS
|-

|link:API/ja/API_gd_cubism_parameter.ja{adocsuffix}[GDCubismParameter]
|GDCubismParameterCS
|○

|link:API/ja/API_gd_cubism_part_opacity.ja{adocsuffix}[GDCubismPartOpacity]
|GDCubismPartOpacityCS
|○

|link:API/ja/API_gd_cubism_user_model.ja{adocsuffix}[GDCubismUserModel]
|GDCubismUserModelCS
|○
|===
